...
UNKNOWN_MESSAGE = (
    "メニューから操作を選んでください。\n"
    "下のリッチメニューをタップするか、\n"
    "「猫の情報・TNR相談」または「個別に相談したい」と入力してください。"
)

CANCEL_MESSAGE = "キャンセルしました。"

# 個別相談 自動返信
CONSULT_AUTO_REPLY = (
    "【自動返信】\n"
    "個別相談の窓口です。\n"
    "このトーク画面に相談内容をそのままお送りください。写真や動画もお送りいただけます。\n"
    "担当者が確認次第、こちらのトークよりご返信いたします。お気軽にどうぞ。\n\n"
    "＜ご注意＞\n"
    "・対応エリアは高松市内に限ります\n"
    "・猫の保護・引き取りは一切行っておりません\n"
    "・他団体のご紹介もできかねます\n"
...
# ─── TNR相談フロー ─────────────────────────────────────────────────────────────
TNR_CAUTIONS = (
    "TNR（捕獲・不妊手術・元の場所へのリリース）のご相談を承ります。\n\n"
    "ご依頼の前に以下の注意事項をご確認ください。\n\n"
    "━━━━━━━━━━━━━━━━\n"
    "・場所や状況によってはお受けできない場合もありますのでご了承ください\n\n"
    "・ご飯をあげている猫のTNRをご依頼の場合、費用の一部をご負担いただく場合があります\n"
    "　補助金制度が利用できる場合はご案内します\n\n"
